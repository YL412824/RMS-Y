...
const proxy = {
  'GET /api/blade-users/list': getFakeList,
  'GET /api/blade-users/detail': getFakeDetail,
  'POST /api/blade-users/grant': fakeSuccess,
  'POST /api/blade-users/reset-password': fakeSuccess,
  'POST /api/blade-users/submit': fakeSuccess,
  'POST /api/blade-users/update': fakeSuccess,
  'POST /api/blade-users/remove': fakeSuccess,
  ...
  'POST /api/register': (req, res) => {
    res.send({ status: 'ok', currentAuthority: 'users' });
  },
  'GET /api/500': (req, res) => {
    res.status(500).send({
