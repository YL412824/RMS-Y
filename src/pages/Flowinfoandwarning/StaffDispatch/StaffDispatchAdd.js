...
import { STAFFDISPATCH_SUBMIT } from '../../../actions/staffdispatch';
...
@Form.create()
class StaffDispatchAdd extends PureComponent {
  handleSubmit = e => {
    e.preventDefault();
    const { dispatch, form } = this.props;
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        dispatch(STAFFDISPATCH_SUBMIT(values));
      }
    });
  };
  ...
  render() {
    ...
    return (
      <Panel title="新增" back="/tool/staffdispatch" action={action}>
...
export default StaffDispatchAdd;
