...
import { CONTINGENCYPLAN_INIT, CONTINGENCYPLAN_CHANGE_INIT, CONTINGENCYPLAN_SUBMIT } from '../../../actions/contingencyplan';
...
@Form.create()
class ContingencyPlanAdd extends PureComponent {
  componentWillMount() {
    ...
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        if (password !== password2) {
          ...
          dispatch(CONTINGENCYPLAN_SUBMIT(params));
        }
      }
    });
  };
  ...
  render() {
    ...
    return (
      <Panel title="新增" back="/system/contingencyplan" action={action}>
...
export default ContingencyPlanAdd;
