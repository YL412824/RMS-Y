...
import { CONTINGENCYPLAN_DETAIL } from '../../../actions/contingencyplan';
import styles from '../../../layouts/Sword.less';
import { tenantMode } from '../../../defaultSettings';

const FormItem = Form.Item;

@connect(({ contingencyplan }) => ({
  contingencyplan,
}))
@Form.create()
class ContingencyPlanView extends PureComponent {
  componentWillMount() {
    const {
      dispatch,
      match: {
    ...
    dispatch(CONTINGENCYPLAN_DETAIL(id));
  }
  ...
  handleEdit = () => {
    ...
    router.push(`/system/contingencyplan/edit/${id}`);
  };
  ...
  render() {
    ...
    return (
      <Panel title="查看" back="/system/contingencyplan" action={action}>
...
export default ContingencyPlanView;
