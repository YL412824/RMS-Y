...
import { DATASHOW_SUBMIT } from '../../../actions/datashow';
...
@Form.create()
class DatashowAdd extends PureComponent {
  handleSubmit = e => {
    e.preventDefault();
    const { dispatch, form } = this.props;
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        dispatch(DATASHOW_SUBMIT(values));
      }
    });
  };
  ...
  render() {
    ...
    return (
      <Panel title="新增" back="/system/datashow" action={action}>
