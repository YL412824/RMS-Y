...
import { COMMONRESOURCE_DETAIL } from '../../../actions/commonresource';
import styles from '../../../layouts/Sword.less';

const FormItem = Form.Item;

@connect(({ commonresource }) => ({
  commonresource,
}))
@Form.create()
class CommonResourceView extends PureComponent {
  componentWillMount() {
    const {
      dispatch,
      match: {
  ...
  handleEdit = () => {
    ...
    router.push(`/system/commonresource/edit/${id}`);
  };

  render() {
    const {
      commonresource: { detail },
    } = this.props;
    ...
    return (
      <Panel title="查看" back="/system/commonresource" action={action}>
...
export default CommonResourceView;
