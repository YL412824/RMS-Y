...
import { COMMONRESOURCE_DETAIL, COMMONRESOURCE_INIT, COMMONRESOURCE_SUBMIT } from '../../../actions/commonresource';
...
@Form.create()
class CommonResourceEdit extends PureComponent {
  state = { visible: false };
  ...
  handleSubmit = e => {
    ...
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        dispatch(COMMONRESOURCE_SUBMIT(params));
      }
    });
  };
  ...
  handleSyncLocale = () => {
    ...
    const locale = form.getFieldValue('commonresourceLocale');
    if (func.isEmpty(locale)) {
      const code = form.getFieldValue('code');
      form.setFieldsValue({ commonresourceLocale: code });
    }
  };
  ...
  render() {
    ...
    return (
      <Panel title="修改" back="/system/commonresource" action={action}>
...
export default CommonResourceEdit;
