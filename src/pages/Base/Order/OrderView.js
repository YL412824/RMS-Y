...
import { OEDER_DETAIL } from '../../../actions/order';
...
class OrderAdd extends PureComponent {
  ...
  handleEdit = () => {
    ...
    router.push(`/desk/order/edit/${id}`);
  };
  ...
  render() {
    ...
    return (
      <Panel title={<FormattedMessage id="button.view.name" />} back="/desk/order" action={action}>
        <Card bordered={false}>
          <Form hideRequiredMark style={{ marginTop: 8 }}>
            ...
            <FormItem {...formItemLayout} label={<FormattedMessage id="desk.order.create_time" />}>
