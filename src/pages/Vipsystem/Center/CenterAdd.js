...
import { CENTER_INIT, CENTER_CHANGE_INIT, CENTER_SUBMIT } from '../../../actions/center';
...
@Form.create()
class CenterAdd extends PureComponent {
  componentWillMount() {
  ...
  render() {
    ...
    return (
      <Panel title="新增" back="/system/center" action={action}>
