...
import { VIPCENTER_DETAIL } from '../../../actions/vipcenter';
...
@Form.create()
class VipCenterView extends PureComponent {
  componentWillMount() {
    const {
      dispatch,
      match: {
  ...
  handleEdit = () => {
    ...
    router.push(`/system/vipcenter/edit/${id}`);
  };
  ...
  render() {
    ...
    return (
      <Panel title="查看" back="/system/vipcenter" action={action}>
