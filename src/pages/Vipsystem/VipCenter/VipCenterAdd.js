...
import { VIPCENTER_INIT, VIPCENTER_CHANGE_INIT, VIPCENTER_SUBMIT } from '../../../actions/vipcenter';
...
@Form.create()
class VipCenterAdd extends PureComponent {
  componentWillMount() {
    ...
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        if (password !== password2) {
          ...
          dispatch(VIPCENTER_SUBMIT(params));
        }
      }
    });
  };
  ...
  render() {
    ...
    return (
      <Panel title="新增" back="/system/vipcenter" action={action}>
